...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    first_name = models.CharField(verbose_name="First name", max_length=30, default="first", blank=False)
    last_name = models.CharField(verbose_name="Last name", max_length=30, default="last", blank=False)
